...
export default function LibraryLayout({children, background}: { children: ReactNode, background?: string }) {
    return (
        <div className="flex flex-col items-center relative max-w-[800px] mx-auto justify-between h-dvh">
            ...
            <div className={`flex-1 flex w-full flex-col items-center justify-center gap-4`}>
